...
const CommentsContainer = styled.div`
  margin-left: ${(props) => (props.c ? "60px" : "0px")};
  width: 100%;
`;
...
const Typerid = styled.text`
  ...
  border-radius: 5px;
  width: 15%;
  width: ${(props) => (props.width ? "80%" : "15%")};
  margin-right: ${(props) => (props.mg ? "15px" : "0px")};
  height: ${(props) => (props.pn ? "95%" : "70%")};
  display: flex;
  align-items: center;
  justify-content: space-around;
`;
...
const ProductDetailsPage = () => {
  ...
  const handleStatus = (e) => {
    e.preventDefault();
    ChangeStatus(dispatch, productId, { user_name });
  };
                ...
                (c) =>
                  !c.status && (
                    <Single>
                      ...
                      <Button onClick={handleStatus}> Share Contact </Button>
                    </Single>
                  )
              )}
            </Passed>
            ...
            <CommentsContainer>
              ...
              <Passed>
                {product.comments?.map((c) => (
                  <Single>
                    <Typerid abc>{c.username}</Typerid>
